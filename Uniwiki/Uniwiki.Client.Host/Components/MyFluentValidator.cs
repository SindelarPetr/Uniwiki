...
namespace Uniwiki.Client.Host.Shared
{
	...
	/// </summary>
    public class MyFluentValidator : UniwikiComponentBase, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        [Parameter]
        public Dictionary<Type, IValidator>
    ChildValidators
        { set; get; } = new Dictionary<Type, IValidator>
        ();
        ...
        /// <returns></returns>
        private (object propertyValue, string propertyName) EvalObjectProperty(object model, string propertyPath, Dictionary<string, object>
            cache)
        {
