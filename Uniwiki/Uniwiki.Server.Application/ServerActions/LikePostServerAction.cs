...
namespace Uniwiki.Server.Application.ServerActions
{
    internal class LikePostServerAction : ServerActionBase<LikePostRequestDto, LikePostResponseDto>
    {
        ...
        public LikePostServerAction(IServiceProvider serviceProvider, IPostRepository postRepository, IProfileRepository profileRepository, ITimeService timeService) : base(serviceProvider)
        {
        ...
        protected override Task<LikePostResponseDto> ExecuteAsync(LikePostRequestDto request, RequestContext context)
        {
            ...
            // Like the post
            _postRepository.LikePost(post, profile, _timeService.Now);
