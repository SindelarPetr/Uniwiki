...
namespace Uniwiki.Server.Application.Services
{
    ...
    internal class DataManipulationService
    {
        ...
        public DataManipulationService(IServiceProvider serviceProvider, AddCommentServerAction addCommentServerAction, LikePostCommentServerAction likePostCommentServerAction, LikePostServerAction likePostServerAction, AddPostServerAction addPostServerAction, ProfileRepository profileRepository, ITimeService timeService, IEmailService emailService)
        {
